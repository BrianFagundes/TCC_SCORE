...
export class DetalhesComponent {
  ...
  async AjustarEquipe() {
    ...
    const dadosEmpresa = {
      ...
      nomeparametro1: this.quantidadeLinhas > 0 ? this.dadosParametrosSalvos[0].parametro + ";" + this.dadosParametrosSalvos[0].importancia + ";" + this.dadosParametrosSalvos[0].avaliacao + ";" + this.modelo + ";" : '',
      nomeparametro2: this.quantidadeLinhas > 1 ? this.dadosParametrosSalvos[1].parametro + ";" + this.dadosParametrosSalvos[1].importancia + ";" + this.dadosParametrosSalvos[1].avaliacao + ";" : '',
      nomeparametro3: this.quantidadeLinhas > 2 ? this.dadosParametrosSalvos[2].parametro + ";" + this.dadosParametrosSalvos[2].importancia + ";" + this.dadosParametrosSalvos[2].avaliacao + ";" : '',
      nomeparametro4: this.quantidadeLinhas > 3 ? this.dadosParametrosSalvos[3].parametro + ";" + this.dadosParametrosSalvos[3].importancia + ";" + this.dadosParametrosSalvos[3].avaliacao + ";" : '',
      nomeparametro5: this.quantidadeLinhas > 4 ? this.dadosParametrosSalvos[4].parametro + ";" + this.dadosParametrosSalvos[4].importancia + ";" + this.dadosParametrosSalvos[4].avaliacao + ";" : '',
      nomeparametro6: this.quantidadeLinhas > 5 ? this.dadosParametrosSalvos[5].parametro + ";" + this.dadosParametrosSalvos[5].importancia + ";" + this.dadosParametrosSalvos[5].avaliacao + ";" : '',
      nomeparametro7: this.quantidadeLinhas > 6 ? this.dadosParametrosSalvos[6].parametro + ";" + this.dadosParametrosSalvos[6].importancia + ";" + this.dadosParametrosSalvos[6].avaliacao + ";" : '',
      nomeparametro8: this.quantidadeLinhas > 7 ? this.dadosParametrosSalvos[7].parametro + ";" + this.dadosParametrosSalvos[7].importancia + ";" + this.dadosParametrosSalvos[7].avaliacao + ";" : '',
      nomeparametro9: this.quantidadeLinhas > 8 ? this.dadosParametrosSalvos[8].parametro + ";" + this.dadosParametrosSalvos[8].importancia + ";" + this.dadosParametrosSalvos[8].avaliacao + ";" : '',
      nomeparametro10: this.quantidadeLinhas > 9 ? this.dadosParametrosSalvos[9].parametro + ";" + this.dadosParametrosSalvos[9].importancia + ";" + this.dadosParametrosSalvos[9].avaliacao + ";" : '',
      nomeparametro11: this.quantidadeLinhas > 10 ? this.dadosParametrosSalvos[10].parametro + ";" + this.dadosParametrosSalvos[10].importancia + ";" + this.dadosParametrosSalvos[10].avaliacao + ";" : '',
      nomeparametro12: this.quantidadeLinhas > 11 ? this.dadosParametrosSalvos[11].parametro + ";" + this.dadosParametrosSalvos[11].importancia + ";" + this.dadosParametrosSalvos[11].avaliacao + ";" : '',
      nomeparametro13: this.quantidadeLinhas > 12 ? this.dadosParametrosSalvos[12].parametro + ";" + this.dadosParametrosSalvos[12].importancia + ";" + this.dadosParametrosSalvos[12].avaliacao + ";" : '',
      nomeparametro14: this.quantidadeLinhas > 13 ? this.dadosParametrosSalvos[13].parametro + ";" + this.dadosParametrosSalvos[13].importancia + ";" + this.dadosParametrosSalvos[13].avaliacao + ";" : '',
      nomeparametro15: this.quantidadeLinhas > 14 ? this.dadosParametrosSalvos[14].parametro + ";" + this.dadosParametrosSalvos[14].importancia + ";" + this.dadosParametrosSalvos[14].avaliacao + ";" : '',
      nomeparametro16: this.quantidadeLinhas > 15 ? this.dadosParametrosSalvos[15].parametro + ";" + this.dadosParametrosSalvos[15].importancia + ";" + this.dadosParametrosSalvos[15].avaliacao + ";" : '',
      nomeparametro17: this.quantidadeLinhas > 16 ? this.dadosParametrosSalvos[16].parametro + ";" + this.dadosParametrosSalvos[16].importancia + ";" + this.dadosParametrosSalvos[16].avaliacao + ";" : '',
      nomeparametro18: this.quantidadeLinhas > 17 ? this.dadosParametrosSalvos[17].parametro + ";" + this.dadosParametrosSalvos[17].importancia + ";" + this.dadosParametrosSalvos[17].avaliacao + ";" : '',
      nomeparametro19: this.quantidadeLinhas > 18 ? this.dadosParametrosSalvos[18].parametro + ";" + this.dadosParametrosSalvos[18].importancia + ";" + this.dadosParametrosSalvos[18].avaliacao + ";" : '',
      nomeparametro20: this.quantidadeLinhas > 19 ? this.dadosParametrosSalvos[19].parametro + ";" + this.dadosParametrosSalvos[19].importancia + ";" + this.dadosParametrosSalvos[19].avaliacao + ";" : '',
      moderador: ID
    };
