...
@Component({
  selector: 'app-notasrecebidas',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './notasrecebidas.component.html',
  styleUrl: './notasrecebidas.component.css'
})
export class NotasrecebidasComponent {
  ...
  {
    localStorage.setItem('notasrecebidas_id', id.toString());
    localStorage.setItem('notasrecebidas_dataavaliacao', data);
    this.router.navigate(['/avaliacaorecebidanotas']);
  }
}
